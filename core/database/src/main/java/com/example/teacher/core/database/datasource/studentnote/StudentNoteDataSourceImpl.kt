...
internal class StudentNoteDataSourceImpl(
    ...
    override fun getStudentNotesByStudentId(
        studentId: Long
    ): Flow<List<BasicStudentNote>> = studentNoteQueries
    ...
    override fun getStudentNoteById(id: Long): Flow<StudentNote?> = studentNoteQueries
    ...
    override fun getStudentFullNameNameById(studentId: Long): Flow<String?> = studentQueries
